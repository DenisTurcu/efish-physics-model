...
for i in range(len(sys.argv)):
    ...
    generate_receptors_responses(
        ...
        fish_bend_angle_lateral_deg=data_params_dict["fish_bend_angle_lateral"],
        fish_bend_angle_dorso_ventral_deg=data_params_dict["fish_bend_angle_dorso_ventral"],
        fish_bend_location_percentages=data_params_dict["fish_bend_location_percentages"],
        fish_yaw_deg=data_params_dict["fish_yaw"],
        fish_pitch_deg=data_params_dict["fish_pitch"],
        fish_roll_deg=data_params_dict["fish_roll"],
        # worm properties
