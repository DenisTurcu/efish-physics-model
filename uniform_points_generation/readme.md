...
This code from [maxkapur/param_tools](https://github.com/maxkapur/param_tools) is used here to help generate grid-arrangement of electroreceptors on various surfaces of fish.
