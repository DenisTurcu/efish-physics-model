...
class SinglePlaneAquarium(Aquarium):
    ...
    def __init__(self, _init_tests=True, **kwds):
        """SinglePlaneAquarium initialization. See parent class "Aquarium" for more details."""
    ...
    def update_image_currents(self, obj: Fish, mode: str = "insert"):
        ...
        See parent class "Aquarium" for more details."""
    ...
    def details(self):
        """Provides the details of the SinglePlaneAquarium. See parent class "Aquarium" for more details."""
