    ...
    def visualize_aquarium(
        ...
        Args:
            ...
            show_image_currents (int, optional): Whether to show the image point currents generated by aquarium
                ...
                marks. Defaults to 0.
            show_worms (bool | float, optional): Whether to show the worms in the aquarium. Defaults to False.
                Value dictates size of scatter marks for the worm point.
        ...
        if isinstance(time_points, int):
            frame_times = [
                int(x)
                for x in np.linspace(self.time_stamps.shape[0] / 5, 4 * self.time_stamps.shape[0] / 5, time_points)
            ]
